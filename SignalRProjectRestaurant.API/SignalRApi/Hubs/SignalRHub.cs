...
namespace SignalRApi.Hubs
{
    public class SignalRHub : Hub
    {
        ...
        public async Task SendStatistic()
        {
            ...
            var value5 = _productService.TProductCountByCategoryNameFirin();
            await Clients.All.SendAsync("ReceiveProductCountByCategoryNameFirin",value5);

            var value6 = _productService.TProductCountByCategoryNameIcecek();
            await Clients.All.SendAsync("ReceiveProductCountByCategoryNameIcecek", value6);
            ...
            var value10 = _productService.TProductPriceAvgFirin();
            await Clients.All.SendAsync("ReceiveProductPriceAvgFirin", value10.ToString("0.00") + " ₺");
        ...
        public async Task SendProgress()
        {
            ...
            var value6 = _productService.TProductPriceAvgFirin();
            await Clients.All.SendAsync("ReceiveAvgPriceByFirin", value6);

            var value7 = _productService.TProductCountByCategoryNameIcecek();
            ...
            var value9 = _productService.TTotalPriceByIcecekCategory();
            await Clients.All.SendAsync("TotalPriceByIcecekCategory", value9);
        }
